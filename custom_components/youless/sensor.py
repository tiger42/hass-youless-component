"""
@ Author      : Gerben Jongerius, Paul de Wit, Robin Harmsen, Marc-Oliver Stühmer
@ Date        : 04/29/2018, 11/01/2018, 04/29/2019, 01/02/2021
...
def setup_platform(hass, config, add_devices, discovery_info=None):
    ...
    for sensor in sensors:
        ...
        devices.append(YoulessSensor(hass, data_bridge, name_prefix, sensor_config[0], sensor, sensor_config[1], sensor_config[2], sensor_config[3], sensor_config[4]))
...
class YoulessSensor(Entity):
    ...
    def __init__(self, hass: HomeAssistantType, data_bridge, name_prefix, name, prpt, sensor_id, uom, icon, image_uri):
        self._state = None
        self._name = name
        self._property = prpt
        self._icon = icon
